...
public class InterfazUsuario {
    ...
    public static void RegistroActividades () {
        ...
        // Simular algunas actividades registradas
        registro.registrarActividad("Inicio de la simulación");
        registro.registrarActividad("Configuración de parámetros");
        registro.registrarActividad("Detención de la simulación");

        // Mostrar actividades anteriores
        registro.mostrarActividadesAnteriores();


    }

    // Clase para representar una simulación
    static class Simulacion {
